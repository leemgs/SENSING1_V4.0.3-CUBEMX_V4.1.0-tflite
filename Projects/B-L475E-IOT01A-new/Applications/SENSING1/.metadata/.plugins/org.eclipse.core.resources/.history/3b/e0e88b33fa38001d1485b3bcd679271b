...
#define AI_HAR_IGN_MODEL_SIGNATURE     "2866b4045c3a29403b9d52fb99b3ff9f"
...
#define AI_TOOLS_DATE_TIME   "Wed Sep 21 00:24:33 2022"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 1728, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_HAR_IGN_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_HAR_IGN_OUT_NUM, &dense_1_nl_output),
  &conv2d_layer, 0, NULL)
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
  ...
  ai_ptr activations = AI_PTR(AI_PTR_ALIGN(activation_buffer->data, AI_HAR_IGN_ACTIVATIONS_ALIGNMENT));
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_1_bias_array.data = AI_PTR(weights + 12240);
    dense_1_bias_array.data_start = AI_PTR(weights + 12240);
